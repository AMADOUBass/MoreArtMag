    ...
    <main className="min-h-screen bg-background-primary pt-32 pb-20">
      <div className="container-custom max-w-4xl py-20">
        ...
        <div className="prose prose-invert max-w-none space-y-16 text-text-secondary leading-relaxed">
          <section className="bg-white/5 p-8 rounded-sm border border-white/5 relative overflow-hidden group">
            ...
            <p className="text-white font-bold mb-4 flex items-center gap-2">
               <ShieldCheck size={20} className="text-success" /> Conformité Loi 25 (Québec)
            </p>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-3xl font-display italic text-white mb-8 flex items-center gap-4">
               <Eye size={28} className="text-accent" /> 01. Collecte des Données
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-3xl font-display italic text-white mb-8 flex items-center gap-4">
               <Lock size={28} className="text-accent" /> 02. Utilisation et Sécurité
            </h2>
            <p>
          ...
          <section>
             <h2 className="text-3xl font-display italic text-white mb-8">03. Témoins (Cookies)</h2>
             <p>
          ...
          <section>
            <h2 className="text-3xl font-display italic text-white mb-8 flex items-center gap-4">
               <ShieldCheck size={28} className="text-accent" /> 04. Responsable de la Protection
            </h2>
            <p>
              Pour toute question relative à vos données ou pour exercer vos droits d'accès et de rectification, vous pouvez contacter :
            </p>
            <div className="bg-white/5 p-8 rounded-sm border border-white/5 mt-6">
              <p className="text-white font-bold text-xl font-display italic">Bazan Togola</p>
              <p className="text-accent eyebrow text-[10px] mt-2">Responsable de la protection des renseignements personnels</p>
              <div className="w-12 h-px bg-white/10 my-4" />
              <p>Email : privacy@moreartmag.com</p>
              <p className="text-xs text-text-muted italic mt-4">Nous nous engageons à répondre à toute demande sous un délai de 30 jours.</p>
            </div>
          </section>
